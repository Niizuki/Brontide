...
| [`open-decisions.md`](open-decisions.md) | Owner decisions with option sets, recommendations, and rulings. **Eleven are recorded**: the two PB0 encoding blockers on 2026-07-24, the eight raised by PB4, PB5, and PB6 on 2026-07-28, and Decision 11, raised by PB7 and ruled on 2026-07-30. **Decisions 12 and 13, raised by CBI20 and CBI21 on 2026-08-01, are open** and running on the current implementation's answers | PB0, extended PB4-PB7, CBI20-CBI21 |
