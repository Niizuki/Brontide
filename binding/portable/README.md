...
| [`open-decisions.md`](open-decisions.md) | Owner decisions with option sets, recommendations, and rulings. **Twelve are recorded**: Decisions 1-11, plus Decision 13 on 2026-08-11, retaining the fail-closed 0.1 boundary and selecting split establishment/readiness with declared relational lifecycle traffic for 0.2. **Decisions 12 and 14-16 remain open** and block no current work | PB0, extended PB4-PB7, CBI20-CBI27 |
