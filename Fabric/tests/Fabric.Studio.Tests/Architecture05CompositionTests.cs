...
public sealed class Architecture05CompositionTests
{
    ...
    public async Task Image_workspace_keeps_the_module_simple_while_facilities_are_adopted_independently()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.StageTwoEvidence.FabricMetadataEntries, Is.EqualTo(1));
    ...
    public async Task Provider_substitution_and_vector_optimisation_remain_operationally_visible()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.FinalEvidence.FabricMetadataEntries, Is.EqualTo(1));
    ...
    [Test]
    public void A_conventionally_hosted_opaque_box_needs_no_internal_dependencies_or_atlas_operation()
    {
