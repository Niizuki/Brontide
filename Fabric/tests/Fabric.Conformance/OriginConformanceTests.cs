...
public sealed class OriginConformanceTests
{
    ...
    public void Direct_origin_assertion_evaluates_mortality_and_fails_closed()
    {
        ...
        Assert.That(
            () => domain.EmitEvent(
                ...
                OriginClass.Device,
                originAuthority),
            Throws.TypeOf<AtlasDenialException>().With.Message.Contains("expired"));
    ...
    public void Direct_origin_assertion_denies_constraints_without_event_semantics()
    {
        ...
        Assert.That(
            () => domain.EmitEvent(
                ...
                OriginClass.Device,
                originAuthority),
            Throws.TypeOf<AtlasDenialException>().With.Message.Contains("fail-closed"));
    ...
    public async Task Completed_execution_context_cannot_reuse_an_old_origin_authorisation()
    {
        ...
        Fabric.Core.ExecutionContext captured = null!;
