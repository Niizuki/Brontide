...
namespace Fabric.Experimental.Composition;

public static class ImageWorkspaceContracts
{
    public static readonly OperationReference Invert = OperationReference.Parse("Fabric:Image.Invert");
    public static readonly ShapeReference ImageFrame = ShapeReference.Parse("Fabric:Image.Frame", 1);
...
public sealed class CpuImageInvertProvider : IImageTransformProvider
{
    public CpuImageInvertProvider()
    {
        Descriptor = new ComponentDescriptor(
            CanonicalName.Parse("Fabric:Image.Invert.Cpu"),
            CanonicalName.Parse("Fabric:ReferenceStack"),
...
/// <summary>
/// A real System.Numerics vector path used as Fabric's current specialised-accelerator evidence.
...
public sealed class VectorImageInvertProvider : IImageTransformProvider
{
    ...
    {
        Descriptor = new ComponentDescriptor(
            CanonicalName.Parse("Fabric:Image.Invert.Vector"),
            CanonicalName.Parse("Fabric:ReferenceStack"),
            [ImageWorkspaceContracts.Invert],
            executionClaims:
            [
...
{
    public static readonly CanonicalName ExecutionHistory = CanonicalName.Parse("Fabric:ExecutionHistory");
    public static readonly CanonicalName RetainedExecutionHistory = CanonicalName.Parse("Fabric:SessionRetainedExecutionHistory");
    public static readonly CanonicalName SearchableMetadata = CanonicalName.Parse("Fabric:SearchableImageMetadata");
    public static readonly CanonicalName WorkspaceState = CanonicalName.Parse("Fabric:WorkspaceState");
}
...
public sealed class InMemoryExecutionHistoryFacility : IWorkspaceFacility
{
    ...
    public FacilityDescriptor Descriptor { get; } = new(
        CanonicalName.Parse("Fabric:Workspace.ExecutionHistory"),
        CanonicalName.Parse("Fabric:ReferenceStack"),
...
{
    public FacilityDescriptor Descriptor { get; } = new(
        CanonicalName.Parse("Fabric:Workspace.SharedState"),
        CanonicalName.Parse("Fabric:ReferenceStack"),
...
public sealed class ImageWorkspaceComposition
{
    ...
    public ImageWorkspaceComposition(IEnumerable<IImageTransformProvider>? providers = null)
    {
        ...
        Domain = AuthorityDomain.Create("Atlas 0.5 image workspace", genesis =>
        {
        ...
        TransformationComponent = new ComponentDescriptor(
            CanonicalName.Parse("Fabric:Image.Invert.Module"),
            CanonicalName.Parse("Fabric:ReferenceStack"),
            [ImageWorkspaceContracts.Invert]);
    }
...
public static class ImageWorkspaceShowcase
{
    public static async ValueTask<ImageWorkspaceShowcaseResult> RunAsync()
    {
        ...
        var fabricMetadata = new InMemoryMetadataFacility(
            CanonicalName.Parse("Fabric:Workspace.Metadata"),
            CanonicalName.Parse("Fabric:ReferenceStack"),
            true);
        ...
        var stageTwoEvidence = new FacilityEvidence(
            ...
            fabricMetadata.Entries.Count,
            0,
            fabricMetadata.SearchByDimensions(smallImage.Width, smallImage.Height).Count(),
        ...
        var substitution = composition.Replace(
            ...
            "Fabric composition → Example provider boundary");
        ...
        return new ImageWorkspaceShowcaseResult(
            ...
            boxed,
            [
                "real Linen Component interchange",
