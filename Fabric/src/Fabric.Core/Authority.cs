...
{
    public static readonly CanonicalName PermittedOperations = CanonicalName.Parse("Fabric:PermittedOperations");
    public static readonly CanonicalName WallClockValidity = CanonicalName.Parse("Fabric:WallClockValidity");
    public static readonly CanonicalName LivenessLease = CanonicalName.Parse("Fabric:LivenessLease");
    public static readonly CanonicalName OriginGrant = CanonicalName.Parse("Fabric:OriginGrant");
}
...
public sealed class Capability
{
    ...
    public Capability Delegate(ActorReference newHolder, params Constraint[] added)
    {
        ...
        {
            throw new InvalidOperationException("Cross-domain Delegation is not part of Atlas Base.");
        }
