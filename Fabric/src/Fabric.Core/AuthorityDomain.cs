...
/// <summary>The single authority and effect gate for one hosted Atlas authority domain.</summary>
public sealed class AuthorityDomain
{
        ...
        bool authorityAlreadyEvaluated)
    {
        ...
        lock (_gate)
        {
            ...
            {
                throw new AtlasDenialException($"Event {kind} is not recognised by domain {Name}.");
            }
        }
