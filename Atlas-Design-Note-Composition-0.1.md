...
**Extracted from:** Atlas Architecture 0.6, §18.1; the architecture document retains a
...
ratifies the Component model or the Atlas Portable Binding, or defines conformance
requirements.
...
inspectable rules. The name follows the Atlas relationship-noun grammar (Delegation,
...
The storage Router remains the first instantiation, and ratification waits on Fabric/Linen
