...
- `Brontide.Minimal.Host` composes the independent Component Management and Portable Binding
  experiments for CBI1-CBI3. It maps one completed native CM2 direct `1..1` position into PB7
  ...
  treated as authority for a portable Operation. It does not merge the projects, support
