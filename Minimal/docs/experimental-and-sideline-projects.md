...
- `Brontide.Minimal.Host` composes the independent Component Management and Portable Binding
  experiments for CBI1-CBI11. It maps one completed native CM2 direct `1..1` position into PB7
  ...
  the same position, with observed use as a veto and no retirement path.
