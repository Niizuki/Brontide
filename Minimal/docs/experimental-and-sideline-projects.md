...
- `Brontide.Minimal.Host` composes the independent Component Management and Portable Binding
  experiments for CBI1-CBI18. It maps one completed native CM2 direct `1..1` position into PB7
  ...
  growth removes nobody and so cannot uncover a declared dependency.
