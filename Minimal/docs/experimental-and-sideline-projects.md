...
- `Brontide.Minimal.Host` composes the independent Component Management and Portable Binding
  experiments for CBI1-CBI23. It maps one completed native CM2 direct `1..1` position into PB7
  ...
  scope, and CBI23 nests those attachments and retires a supplied forest deepest first.
  It does not merge the projects, perform a lifecycle handshake, migrate a Port between generations,
