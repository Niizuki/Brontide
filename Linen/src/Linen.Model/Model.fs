...
module BuiltIn =
    ...
    let unitShape = shape "atlas.base.unit" 1
    let booleanShape = shape "atlas.base.boolean" 1
    let integerShape = shape "atlas.base.integer" 1
    let decimalShape = shape "atlas.base.decimal" 1
    let textShape = shape "atlas.base.text" 1
    let bytesShape = shape "atlas.base.bytes" 1
