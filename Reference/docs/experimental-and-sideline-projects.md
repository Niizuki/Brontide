...
Reference Studio is the composition root for the CBI1-CBI27 integration slices. It references the
...
realized as, CBI26 admits that mediator's own authority, and CBI27 carries a position wider than
`1..1` into preflight as one ordinary member per resolved member. This
...
mediated member, activate a fanned-out Provider Set, or establish real Component interchange.
