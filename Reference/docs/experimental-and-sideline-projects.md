...
Reference Studio is the composition root for the CBI1-CBI16 integration slices. It references the
...
undeclared use condemns the activation. This does not merge the experimental projects,
