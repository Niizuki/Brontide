...
Reference Studio is the composition root for the CBI1-CBI12 integration slices. It references the
...
under one CM4 activation, with the release barrier at the activation rather than at any member. This does not merge the experimental projects,
