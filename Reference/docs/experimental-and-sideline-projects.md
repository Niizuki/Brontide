...
Reference Studio is the composition root for the CBI1-CBI28 integration slices. It references the
...
`1..1` into preflight as one ordinary member per resolved member, and CBI28 activates those members
under one release barrier. This
