...
public sealed class ReferenceHostsMinimalTests
{
    private static ProviderLaunch MinimalProvider(params string[] arguments)
    {
    ...
    {
        var host = new ReferenceCoolingBindingHost(MinimalProvider(), TimeProvider.System);
        var provider = EnrichmentProvider.Project(
            CanonicalName.Parse("interchange.tests.brontide-reference-host-context"),
        ...
        var enrichment = new TargetedEnrichmentComposition(
            "Brontide.Reference interchange host",
            host.Domain.Shapes,
            [provider]);
        ...
        var enriched = enrichment.Resolve(
            ...
            InterchangeCoolingContract.HostContext,
            baseInput,
            [AvailableValue.Direct("requester", ShapeValue.Text("brontide-reference-requester"), "host-local actor label")]);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.Observation.SelectedProvider, Is.EqualTo("brontide-minimal-fsharp-provider"));
    ...
    {
        var deniedHost = new ReferenceCoolingBindingHost(MinimalProvider(), TimeProvider.System);
        ...
        var unknownHost = new ReferenceCoolingBindingHost(MinimalProvider(), TimeProvider.System);
        ...
        var fragmentHost = new ReferenceCoolingBindingHost(MinimalProvider(), TimeProvider.System);
    ...
    public async Task Semantic_failure_crosses_as_shaped_failed_Outcome_without_exception_transport()
    {
        ...
        var result = await host.ExecuteAsync(
            ...
            InterchangeCoolingContract.Command(
                ...
                requesterLabel: "brontide-reference-requester"));
    ...
    {
        var shapeHost = new ReferenceCoolingBindingHost(
            MinimalProvider(),
            TimeProvider.System,
        ...
        var missingShape = await shapeHost.ExecuteAsync(
            ...
            InterchangeCoolingContract.Command("primary", true, requesterLabel: "brontide-reference-requester"));

        var operationHost = new ReferenceCoolingBindingHost(
            MinimalProvider(),
            TimeProvider.System,
    ...
    {
        var protocolHost = new ReferenceCoolingBindingHost(
            MinimalProvider("--reject-protocol"),
            TimeProvider.System);
        ...
        var crashHost = new ReferenceCoolingBindingHost(
            MinimalProvider("--crash-after-activation"),
            TimeProvider.System);
