...
| [Design reviews](./reviews/README.md) | Fresh-context review policy and retained attestations | 16 retained attestations, one `conforms-with-nonblocking-findings`; 28 iteration reviews: V, W, X, Y, Z, AA, AB, AC, AD, AM, AN, AO, AP, AQ, AR, AS, AT, AU, AV, AW, AX, AY, AZ, BA, BB, BC, BD, BE, BF, BG, BH, BI, BJ. [Disposition index](./reviews/channel-0.2-disposition-index.md#design-reviews). |
