...
2026-08-11. Four first-review blockers have contract-first corrections; implementation remains gated
on a conforming fresh closure review.
...
| [Interaction state machine](./Brontide-Channel-0.2-Interaction-State-Machine-0.1.md) | Admission, concurrency, cancellation, terminality, and effect certainty | B1/B2 corrected; closure review pending |
| [Responsibility matrix](./Brontide-Channel-0.2-Responsibility-Matrix-0.1.md) | One semantic owner and neutral crossing artifact per concern | B3 corrected; closure review pending |
| [Contract-completeness review](./Brontide-Channel-0.2-Contract-Completeness-Review-0.1.md) | Separate review of silence and extension pressure | Correction pass complete; closure review pending |
| [0.1-to-0.2 migration ledger](./Brontide-Channel-0.1-to-0.2-Migration-Ledger-0.1.md) | Disposition of predecessor Shapes, fields, states, categories, limits, observations, vectors, and goldens | B4 corrected; closure review pending |
...
| [Design reviews](./reviews/README.md) | Fresh-context review policy and retained attestations | Negative review retained; closure review pending |
