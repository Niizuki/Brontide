...
2026-08-11. B1-B4, N1-N3, F1-F3, D1-D5, T1-T4, R1-R3, S1-S3, U1-U8, and V1-V2 all have contract-first
corrections, including a closed state/event grid. Every recorded finding being closed is not a
verdict; implementation remains gated on a conforming fresh independent closure re-review, which is
the only judgement that can close the batch.
