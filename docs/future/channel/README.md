...
nothing it can fix, and the eleven that have run raised **AM1**-**AM3**, **AN1**-**AN6**,
**AO1**-**AO3**, **AP1**-**AP2**, **AQ1**-**AQ5**, **AR1**, **AS1**-**AS7**, **AT1**-**AT7**,
**AU1**-**AU5**, **AV1**-**AV3**, and **AW1**. Batch 2 stays closed
