...
2026-08-11. B1-B4, N1-N3, and F1-F3 have contract-first corrections; implementation remains gated
on a conforming fresh definitive closure review.
...
| [C1-C12 capability contract](./Brontide-Channel-0.2-Capability-Contract-0.1.md) | Observable capability, effects, failures, properties, evidence, and silence | N2/F1/F2 corrected; definitive review pending |
...
| [Interaction state machine](./Brontide-Channel-0.2-Interaction-State-Machine-0.1.md) | Admission, concurrency, cancellation, terminality, and effect certainty | B1/B2/N2/F1/F2 corrected; definitive review pending |
...
| [Contract-completeness review](./Brontide-Channel-0.2-Contract-Completeness-Review-0.1.md) | Separate review of silence and extension pressure | B1-B4/N1-N3/F1-F3 corrected; definitive review pending |
| [0.1-to-0.2 migration ledger](./Brontide-Channel-0.1-to-0.2-Migration-Ledger-0.1.md) | Disposition of predecessor Shapes, fields, states, categories, limits, observations, vectors, and goldens | B4/N1/N3/F3 corrected; definitive review pending |
...
| [Design reviews](./reviews/README.md) | Fresh-context review policy and retained attestations | Three negative reviews retained; definitive review pending |
