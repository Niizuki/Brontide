...
The current review target is the commit titled `refactor(channel): own the unseen refusal record and
delete the AL2 sweep`, committed 2026-08-20, which is the head of the correction sequence beginning at
