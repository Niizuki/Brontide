...
| F — independent-review invariant gaps | Implemented; focused regressions and the full local gate pass; fresh pinned review pending | Reference Genesis/provenance/liveness tests and matrix; Minimal Fragment-host-lineage test and matrix; both changelogs |
...
reproduced Finding F. Its focused regression suites and the complete local two-stack gate passed on
2026-07-23. The correction must still be committed and both reviews repinned before deletion can be
authorized.
