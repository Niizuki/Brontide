...
pre-existing mutable lease state in Reference. Those deeper cases are being corrected and must pass
the complete gate and both repinned reviews before deletion can be authorized.
