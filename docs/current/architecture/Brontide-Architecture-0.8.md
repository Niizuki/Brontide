...
**Status:** Complete Draft (document and implementation evidence complete; not ratified)
...
[Channel](../../future/channel/Brontide-Design-Note-Channel-0.1.md). The recorded frame is framed one-message-per-frame
...
[Topology Environments and the Guardian Family](../../future/topology/Brontide-Design-Note-Topology-0.1.md). A **Topology Map** is an
...
The [retained reasoning](../../future/topology/Brontide-Design-Note-Topology-0.1.md#retained-objection-and-resolution-sentinel-as-a-universal-observer)
...
now recorded in [the Channel design note](../../future/channel/Brontide-Design-Note-Channel-0.1.md); it remains a
