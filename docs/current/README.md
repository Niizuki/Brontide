...
The following current documents remain outside this directory because their paths are pinned:

- [Architecture 0.7](../../Brontide-Architecture-0.7.md), the locally declared implementation
  target for both stacks;
- [architecture change history](../../Brontide-Architecture-Change-History.md);
- [public boundaries](../public-boundaries.md);
