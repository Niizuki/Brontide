...
$migrationPath = Join-Path $repositoryRoot 'docs\current\architecture\architecture-0.8-d3-breaking-migration.md'
$reviewPath = Join-Path $repositoryRoot 'docs\archive\architecture\architecture-0.8-d3-completeness-review.md'
