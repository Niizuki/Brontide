...
**Extracted from:** Atlas Architecture 0.6, §18.2; the architecture document retains a
summary section under the same number.
**Scope:** Records design directions. Nothing in this note enlarges Atlas Base,
